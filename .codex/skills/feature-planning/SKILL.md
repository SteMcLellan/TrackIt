...
## Required Sections
Follow the template in `.codex/prompts/feature-plan.md`, including:
- Feature Summary
- Rollout / Scope
...
## Output Form (feature doc template)
Use the template in `references/FORMS.md` for new specs and updates.
